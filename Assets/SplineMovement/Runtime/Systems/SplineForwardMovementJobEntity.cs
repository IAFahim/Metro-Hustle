    ...
    public partial struct SplineForwardMovementJobEntity : IJobEntity
        {
            ...
            private void Execute(ref LocalTransform localTransform, ref SplineLinkComponentData splineLinkComponentData,
                in SpeedComponentData speedComponentData, in SplineLineNumberComponentData splineLineNumberCompData)
            {
                ...
                if (splineLinkComponentData.Progress >= 1)
                {
                    ...
                    if (splineLinkComponentData.KnotIndex >= NativeSplineBlob.Value.Curves.Length)
                    {
                        // Stop, loop, destroy, etc. Example: Loop back to start
                        splineLinkComponentData.KnotIndex = 0;
                    }
                }
                ...
                var currentKnotIndex = splineLinkComponentData.KnotIndex;
                ...
                float desiredOffset = splineLineNumberCompData.Value; // Use the value from the component
