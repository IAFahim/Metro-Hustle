    ...
    internal static class MakeEcsFolder
    {
        ...
        internal class DoCreateFolder : EndNameEditAction
        {
                ...
                string editorParentFolder)
            {
                ...
                var name = newFolderName.Replace(" ", "");
                var content = FileInteract.ReadAndReplace(runtimeParentFolder, name);
                FolderUtil.CreateFile(runtimeParentFolder, $"{name}.asmdef", content);
            }
        }
    }
}